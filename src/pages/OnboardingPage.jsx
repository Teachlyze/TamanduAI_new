  ...
  const submit = async (e) => {
    ...
    try {
      ...
      try {
        ...
        console.error(
          "[Onboarding] Failed to log terms acceptance:",
          auditError
        );
      }
      ...
      if (form.role === "student") {
        ...
        try {
          ...
          console.error(
            "[Onboarding] Error initializing gamification:",
            gamError
          );
      ...
      <div className="w-full max-w-xl p-6 space-y-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Informe seus dados para continuar usando a plataforma.
          </p>
        </div>
        <form onSubmit={submit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="age">
                Idade <span className="text-base-content/50">(opcional)</span>
              </Label>
              <Input
                id="age"
                type="number"
