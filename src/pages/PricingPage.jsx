          ...
          <PremiumCard variant="elevated">
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-4 leading-relaxed max-w-3xl mx-auto">
                Desde professores individuais até grandes redes escolares, temos
                um plano que se adapta às suas necessidades.
              </p>
              <p className="text-lg text-green-600 font-semibold mb-8 max-w-3xl mx-auto">
                ✨ Cadastre-se agora e ganhe 3 meses gratuitos do plano Pro •
                Vagas limitadas: 847/1000
              </p>
              ...
              <div className="flex items-center justify-center gap-4 mb-8">
                ...
                <Badge className="bg-green-100 text-green-700 ml-2">
                  <Gift className="mr-1 h-3 w-3" />2 meses grátis
                </Badge>
              </div>
            </motion.div>
          </PremiumCard>
          ...
          <PremiumCard variant="elevated">
            ...
            >
              ...
              <p className="text-gray-600">
                Escolha o plano que melhor se adapta ao seu tamanho
              </p>
            </motion.div>
              ...
              <TabsContent value="teachers">
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {teacherPlans.map((plan, index) => (
                    ...
                    >
                      <Card
                        className={`relative h-full ${plan.popular ? "border-4 border-indigo-500 shadow-2xl scale-105" : ""}`}
                      >
                        {plan.popular && (
                              ...
                              <>
                                ...
                                {billingCycle === "yearly" && (
                                  <p className="text-sm text-green-600 mt-1">
                                    R$ {(plan.price * 10).toFixed(0)}/ano (2
                                    meses grátis)
                                  </p>
                                )}
                              </>
              ...
              <TabsContent value="schools">
                <div className="grid md:grid-cols-3 gap-6">
                  {schoolPlans.map((plan, index) => (
                    ...
                    >
                      <Card
                        className={`relative h-full ${plan.name === "Escola Média" ? "border-4 border-orange-500 shadow-2xl scale-105" : ""}`}
                      >
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="text-center">
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-bold mb-4">
                    IA Proprietária com RAG
                  </h3>
                  <p className="text-gray-600 mb-4">
                    Modelo treinado especificamente para educação brasileira,
                    com Retrieval-Augmented Generation baseado nos materiais do
                    professor.
                  </p>
              ...
              <Card className="text-center">
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-bold mb-4">
                    Programa de Descontos Único
                  </h3>
                  <p className="text-gray-600 mb-4">
                    Contribua questões ao banco coletivo e ganhe até 30% de
                    desconto. Professores ganham dinheiro compartilhando
                    conhecimento.
                  </p>
              ...
              <Card className="text-center">
                <CardContent className="p-8">
                  ...
                  <p className="text-gray-600 mb-4">
                    Previsão de desempenho, clustering automático de alunos,
                    análise de sentimento e recomendações personalizadas.
                  </p>
          ...
          <PremiumCard variant="elevated">
            ...
            >
              ...
              <p className="text-xl md:text-2xl mb-8 text-indigo-100 leading-relaxed">
                Seja um dos primeiros 1.000 educadores a ganhar{" "}
                <strong className="text-white">
                  3 meses de acesso gratuito
                </strong>{" "}
                ao plano Pro. Depois, continue por apenas{" "}
                <strong className="text-white">R$ 69/mês</strong>.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 text-left">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                  ...
                  <p className="text-indigo-100 text-sm">
                    Cadastro 100% gratuito. Só adiciona cartão após os 3 meses
                    se quiser continuar.
                  </p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                  ...
                  <p className="text-indigo-100 text-sm">
                    Comece a usar todos os recursos do plano Pro em menos de 5
                    minutos.
                  </p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                  ...
                  <p className="text-indigo-100 text-sm">
                    Sem compromisso. Cancele a qualquer momento com 1 clique,
                    sem multas.
                  </p>
                </div>
              </div>
              ...
              <p className="mt-8 text-base text-indigo-200">
                ⏰ Vagas limitadas • 🎯 847/1000 vagas restantes • 🔒 Dados 100%
                seguros e LGPD compliant
              </p>
            </motion.div>
          </PremiumCard>
        </div>
          ...
          <PremiumCard variant="elevated">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
              <div className="col-span-1 md:col-span-2">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <span className="text-2xl font-bold bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent text-white hover:opacity-90">
                    TamanduAI
                  </span>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <Badge className="bg-indigo-600 text-white">100% LGPD</Badge>
                </div>
              </div>
              <div>
            ...
            <div className="border-t border-slate-800 pt-8 text-center">
              ...
              <p className="text-slate-600 text-sm mt-2">
                Feito com para educadores brasileiros
              </p>
            </div>
          </PremiumCard>
        </div>
