...
const PerformanceMonitor = () => {
  ...
  const cacheHitRate =
    metrics.queryCache.hits + metrics.queryCache.misses > 0
      ? (metrics.queryCache.hits /
          (metrics.queryCache.hits + metrics.queryCache.misses)) *
        100
      : 0;

  const lazyLoadProgress =
    metrics.lazyComponents.total > 0
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <Badge variant="outline">
                    {metrics.queryCache.hits} hits
                  </Badge>
                </div>
                <div className="flex justify-between items-center">
                  <span>Consultas Perdidas</span>
                  <Badge variant="outline">
                    {metrics.queryCache.misses} misses
                  </Badge>
                </div>
                <div className="flex justify-between items-center">
                  <span>Componentes Lazy Carregados</span>
                  <Badge variant="outline">
                    {metrics.lazyComponents.loaded}/
                    {metrics.lazyComponents.total}
                  </Badge>
                </div>
              </div>
            </CardContent>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm">
                        idx_classes_teacher_active
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                      <span className="text-sm">
                        idx_activities_class_status
                      </span>
                    </div>
                  </div>
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                      <span className="text-sm">
                        idx_student_progress_activity
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                      <span className="text-sm">
                        idx_activities_search (GIN)
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg border border-green-200 dark:border-green-800">
                  <div className="space-y-2 text-sm">
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        Dashboard: Consulta única com JOINs apropriados
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="text-green-600">✅</span>
                      <span>
                        Atividades: Consulta composta com métricas incluídas
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="text-green-600">✅</span>
                      <span>
                        Progresso: Consulta otimizada com dados de atividade
                      </span>
                    </div>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Divisão inteligente do código em chunks menores para carregamento
              sob demanda
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Carregamento inteligente de componentes baseado em interações e
              visibilidade
            </p>
          </div>
