        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-blue-100 text-lg">
              Informações completas e acompanhamento acadêmico
            </p>
          </div>
        </div>
    ...
    try {
      ...
      const mockActivities = [
        ...
        },
        {
          ...
          feedback:
            "Entregue com atraso. Conteúdo bom, mas poderia ser mais detalhado.",
        },
      ];
      ...
      toast({
        ...
        description:
          "Não foi possível carregar as atividades do aluno. Tente novamente mais tarde.",
      });
    } finally {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
        <div className="flex flex-col items-center justify-center min-h-screen p-4 text-center">
          ...
          <p className="text-muted-foreground mb-4">
            Não foi possível carregar os dados do aluno solicitado.
          </p>
  ...
  const {
    ...
    const avg =
      activities.length > 0
        ? parseFloat(
            (
              activities.reduce((sum, a) => sum + (a.grade || 0), 0) /
              activities.length
            ).toFixed(1)
          )
        : 0;
