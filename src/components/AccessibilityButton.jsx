  ...
  useEffect(() => {
    const applySettings = () => {
      ...
      const mainElements = document.querySelectorAll(
        "div, p, span, h1, h2, h3, h4, h5, h6, button, a, input, textarea, select"
      );
        ...
        {isOpen && (
          <>
            ...
            >
              {/* Cabeçalho */}
              <div
                className={`p-4 border-b ${isDark ? "border-gray-700" : "border-gray-100"}`}
              >
              ...
              <div className="p-4 space-y-6 max-h-96 overflow-y-auto">
                ...
                <div className="p-4 bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 dark:from-amber-900/20 dark:via-orange-900/20 dark:to-yellow-900/20 rounded-2xl border-2 border-amber-200 dark:border-amber-800">
                  <div className="flex items-center justify-between">
                    ...
                    >
                      <div
                        className={`absolute w-6 h-6 bg-white rounded-full shadow-md transition-all duration-300 flex items-center justify-center ${
