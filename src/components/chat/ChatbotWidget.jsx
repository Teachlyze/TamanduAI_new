...
const ChatbotWidget = ({
  ...
  const handleQuickAction = useCallback(
    (action) => {
      const actionMessages = {
        ...
        features:
          "Ofereço suporte a múltiplos idiomas, integração com APIs, análise de dados e assistência personalizada.",
        about:
          "Esta é uma plataforma avançada de assistência virtual desenvolvida para oferecer suporte completo aos usuários.",
      };
  ...
  return (
    <Card
      className={cn("chatbot-widget flex flex-col", className)}
      style={{ height: "600px" }}
      {...props}
    >
      {/* Header */}
