...
const variantClasses = {
  ...
  gradient:
    "text-white border-0 shadow-lg hover:shadow-xl bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 hover:from-indigo-700 hover:via-purple-700 hover:to-pink-700",
  gradientOutline:
    "bg-transparent border-2 border-transparent text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 hover:opacity-90",
};
...
const baseClasses =
  "inline-flex items-center justify-center gap-2 rounded-md text-sm font-medium whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 ring-offset-background disabled:opacity-60 disabled:cursor-not-allowed active:translate-y-px";
  ...
  (
    ...
    const accessibleLabel = useMemo(() => {
      ...
      if (!children && (leftIcon || rightIcon)) {
        console.warn(
          "Button: Icon buttons should have an explicit aria-label for accessibility"
        );
    ...
    return (
      <Comp {...buttonProps}>
        ...
        {leftIcon && (
          <span className="flex-shrink-0" aria-hidden="true" role="img">
            {leftIcon}
          </span>
        )}
...
export const AccessibleButton = React.forwardRef(
  (
    ...
    <Button
      ...
      size={size}
      aria-label={
        ariaLabel || (typeof children === "string" ? children : "Botão")
      }
      aria-describedby={ariaDescribedBy}
