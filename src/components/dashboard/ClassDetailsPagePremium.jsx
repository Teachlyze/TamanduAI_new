  ...
  const fetchClassDetails = useCallback(async () => {
    ...
    try {
      ...
      setStats({
        ...
        totalActivities: 12, // TODO: buscar real
        pendingSubmissions: 5, // TODO: buscar real
        averageGrade: 8.5 // TODO: buscar real
      });
              ...
              <TabsContent value="feed" className="mt-0">
                ...
                >
                  <EmptyState
                    icon={MessageSquare}
                    title="Feed da Turma"
                    description="Aqui aparecerão os posts, atividades e anúncios da turma"
                    actionLabel={isTeacher ? "Criar Primeiro Post" : undefined}
                    onAction={isTeacher ? () => console.log('Create post') : undefined}
                  />
                </motion.div>
              </TabsContent>
                ...
                <PremiumCard variant="elevated" className="p-6">
                  ...
                  {students.length > 0 ? (
                    ...
                    <EmptyState
                      ...
                      description="Convide alunos para começar a usar esta turma"
                      actionLabel={isTeacher ? "Convidar Primeiro Aluno" : undefined}
                      onAction={isTeacher ? () => setActiveTab('invites') : undefined}
                    />
                  )}
                </PremiumCard>
              </TabsContent>
              ...
              {isTeacher && (
                <TabsContent value="analytics" className="mt-0">
                  <EmptyState
                    ...
                    description="Visualize estatísticas detalhadas e progresso dos alunos"
                  />
                </TabsContent>
              )}
