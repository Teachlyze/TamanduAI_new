  ...
  const cookieCategories = [
    {
      ...
      description:
        "Essenciais para o funcionamento básico do site. Garantem segurança e funcionalidades principais.",
    ...
    },
    {
      ...
      description:
        "Utilizados para personalizar anúncios e conteúdo baseado nos seus interesses.",
    ...
    },
    {
      ...
      description:
        "Lembram suas preferências e escolhas para oferecer experiência customizada.",
        ...
        >
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-3">
              Suas{" "}
              <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent text-white hover:opacity-90">
                Preferências
              </span>{" "}
              de Privacidade
            </h1>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Você tem total controle sobre seus dados. Escolha quais tipos de
              cookies deseja permitir.
            </p>
          </div>
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-3">
                        <div
                          className={`w-12 h-12 bg-gradient-to-r from-${category.color}-400 to-${category.color}-600 rounded-xl flex items-center justify-center`}
                        >
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-gray-700 dark:text-gray-300">
                ...
                <p>
                  ...
                  Respeitamos sua privacidade e mantemos seus dados seguros
                  seguindo a <strong>LGPD</strong> e melhores práticas
                  internacionais.
                </p>
              </div>
            </div>
