import{u as L,r as p,s as j,j as e,x as w,F as b,H as y,V as m,y as N,D as T,a0 as q,m as v,d as k,C as O,i as C}from"./main-Cv3DLBs1.js";import{B as S}from"./badge-CS76XO47.js";import{E as B}from"./external-link-B6t_H3_H.js";const W=({userRole:i="student"})=>{const{user:o}=L(),[u,$]=p.useState([]),[D,f]=p.useState(!0);p.useEffect(()=>{if(o){_();const t=setInterval(_,6e4);return()=>clearInterval(t)}},[o,i]);const E=(t=new Date)=>["sunday","monday","tuesday","wednesday","thursday","friday","saturday"][t.getDay()],_=async()=>{try{f(!0);const t=new Date,n=E(t),s=`${t.getHours().toString().padStart(2,"0")}:${t.getMinutes().toString().padStart(2,"0")}`,x=t.toISOString().split("T")[0];let l;i==="student"?l=j.from("class_members").select(`
            class_id,
            classes!inner (
              id,
              name,
